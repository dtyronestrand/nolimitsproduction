import { c as create_ssr_component, d as escape, b as add_attribute, v as validate_component } from "../../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(SliceSimulator, "SliceSimulator").$$render($$result, { background: "#030729" }, {}, {
    default: ({ slices }) => {
